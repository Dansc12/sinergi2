...
import { ArrowLeft, Image, X, Globe, Users, Camera, ChevronDown, ChevronUp, Sparkles, Loader2, Tag, Plus } from "lucide-react";
            ...
            {visibility !== "private" && (
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="Give your workout a unique name..."
                  value={workoutTitle}
                ...
                {(isAutoGeneratedName || !workoutTitle.trim()) && (
                  <p className="text-xs text-destructive">
                    Please provide a custom workout name (not auto-generated)
                  </p>
                )}
              </div>
            )}
            ...
            {visibility !== "private" && (
              <div className="space-y-2">
                ...
                {workoutTags.length === 0 && (
                  <p className="text-xs text-destructive">
                    Add at least one tag to help others find your workout
                  </p>
                )}
