        ...
        {searchValue.length < 2 && selectedFoods.length === 0 && (
          <div className="space-y-4">
            ...
            {isLoadingRecentFoods ? (
              ...
              <div className="text-center py-8 text-muted-foreground">No recent foods yet. Start logging meals!</div>
            ) : (
                          ...
                          <div className="flex-1">
                            <div className="flex items-center gap-2">
                              ...
                              <span className="font-medium text-sm text-foreground">
                                {food.description}
                                {food.isSessionFood && <span className="ml-2 text-xs text-primary">(just added)</span>}
                              </span>
                            </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex items-start justify-between p-3 pt-4">
                        ...
                        {showRemove && (
                          <Button variant="ghost" size="icon" className="h-6 w-6" onClick={() => removeFood(food.id)}>
                    ...
                    {Object.entries(groups).map(([groupId, foods]) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="flex items-center justify-between p-3 pt-4 border-b border-border/50">
                            <div className="flex items-center gap-3">
                              ...
                              <div className="h-10 w-10 shrink-0 rounded-full overflow-hidden bg-primary/20">
                                {coverPhoto ? (
                                  <img src={coverPhoto} alt={mealName} className="h-full w-full object-cover" />
                                ) : (
                          ...
                          {/* Individual foods */}
                          <div className="p-2 space-y-2">{foods.map((food) => renderFoodItem(food, false))}</div>
                        </motion.div>
                      );
                    })}
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="flex items-start justify-between p-4 pt-5">
                            ...
                            <Button variant="ghost" size="icon" className="h-8 w-8" onClick={() => removeFood(food.id)}>
