...
const UserProfilePage = () => {
  ...
  const { status, isFollowing, follow, unfollow, currentUserId } = useFollow(userId || null);
  ...
  const fullName = isFollowing && profile.last_name ? `${profile.first_name} ${profile.last_name}` : displayName;
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="px-4 py-6 animate-fade-in">
        ...
        <div className="mb-6">
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            {!isOwnProfile && (
              <>
                {isFollowing ? (
                  <Button size="sm" onClick={unfollow} className="gap-1">
                    <Check size={16} />
                    Following
                  </Button>
                ) : (
                  <Button variant="outline" size="sm" onClick={follow} className="gap-1">
                    <UserPlus size={16} />
                    Follow
                  </Button>
                )}
        ...
        {/* Content Feed - Show based on following (keeps same visibility string for now) */}
        <div className="grid grid-cols-2 gap-1">
          {activeTab === "posts" ? (
            ...
            <ProfileContentFeed
              ...
              userId={userId}
              visibility={isFollowing ? "friends" : "public"}
              emptyState={{
